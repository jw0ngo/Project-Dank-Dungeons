...
This markdown file is intended to be portable context for another LLM or image-generation agent. Treat it as the source of truth for the current art direction.
