...
## Rank-10 capstones — distinctive over uniformly "epic" (Josh, 2026-06-12)

**Riftmaw** (Pillars of Fire's 🔥 leaf — a map-crossing chaos rift you place at the cursor that tears open across
the screen and lingers ~20s) is a **great** capstone. But its appeal is a **specific creative idea**, not a
template. **The trap to avoid (a wrong turn caught 2026-06-12):** making every rank-10 "epic" through the *same
lever* — especially **"affect the whole map."** Many abilities, *especially within one god*, all going map-scale
reads as repetitive soup, and it makes the genuine standouts (Riftmaw) stop standing out.

- **Creativity is the lever, not scale.** A capstone earns memorability from a *distinct* idea — a new shape, a
  reveal, a risk/reward twist, a placement choice — not from being bigger or covering more ground.
- **Vary the kind *and* the intensity.** Some capstones are big spectacles; others are tight signature mechanics.
  **Not every rank-10 must be super-epic** — restraint on most is what lets the loud ones land. (Hellfront's
  advancing walls and Wyrmspine's re-erupting heal-pillar are *fine as they are* — Josh, 2026-06-12.)
- **Riftmaw is one example of a creative capstone, not the mold.** Don't copy its map-scale; find each leaf's own
  idea when one genuinely wants lifting.
