...
- ◻️ 🎨 **Chaosfire + dragonfire ground-circle sprites** (↳ from ART, 2026-06-11) — two painted filled-disc FX for the burning **ground-circle** substances (`assets/fx/chaosfire-circle.png` crimson · `assets/fx/dragonfire-circle.png` prismatic). Black-bg, 512², `'lighter'`-ready, floored to true black. **Pure visual swap — no hitbox/`f.r` change.**
  ...
  - **Load** (FR_SPR pattern): `const CHAOSFIELD_SPR=new Image(); CHAOSFIELD_SPR.src='assets/fx/chaosfire-circle.png';` + dragonfire; `const FIELD_SPR={chaosfire:CHAOSFIELD_SPR, dragonfire:DRAGONFIELD_SPR};`
