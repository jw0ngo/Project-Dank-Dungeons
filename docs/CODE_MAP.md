...
*Regenerated from `index.html`'s `// §` banners by `tools/gen-code-map.py` (2026-06-13, 17915 lines). Re-run the tool after adding/moving a section or a notable system; **edit the banners, not this file.** Sections appear in FILE ORDER (the § numbers are stable names, not positions — e.g. §10 INIT lives near the end).*
...
## §6  DUNGEON ENGINE
*lines 3462–3465* · 0 function(s) · 0 knob(s)

## §6a  PLAYER SYSTEM
*lines 3466–3716* · 3 function(s) · 0 knob(s)

**Functions:** `makePlayerState` · `gResume` · `isGameActive`

## §6b  SWORD & WHIRLWIND SYSTEM
*lines 3717–5040* · 42 function(s) · 7 knob(s)
...
## §6e  ENEMY SYSTEM
*lines 5041–5065* · 1 function(s) · 0 knob(s)

**Functions:** `mpNearestTarget`

## §6c  HAZARDS & PICKUPS
*lines 5066–5391* · 10 function(s) · 10 knob(s)

**Functions:** `_bombExplodeFeedback` · `gUpdateBombs` · `gClientBombTick` · `gUpdateTraps` · `gDrawTraps` · `gMaybeDropPotion` · `gUpdatePotions` · `gDrawPotions` · `eNearestTarget` · `eAnyPlayerNear`
...
## §7  MULTIPLAYER
*lines 10764–11784* · 21 function(s) · 6 knob(s)
...
*lines 11785–12209* · 30 function(s) · 3 knob(s)
...
## §9  MAP SEED SYSTEM
*lines 12210–13728* · 78 function(s) · 16 knob(s)
...
## §11  WILDERNESS MODE
*lines 13729–14437* · 5 function(s) · 10 knob(s)
...
*lines 14438–15993* · 64 function(s) · 28 knob(s)
...
## §12b  OBELISK SYSTEM
*lines 15994–16165* · 6 function(s) · 12 knob(s)
...
## §13  FOG OF WAR
*lines 16166–16515* · 9 function(s) · 10 knob(s)
...
## §15  SHRINE SYSTEM
*lines 16804–16901* · 3 function(s) · 1 knob(s)
...
## §10  INIT
*lines 16902–17453* · 33 function(s) · 2 knob(s)
...
*lines 17454–17915* · 6 function(s) · 0 knob(s)
