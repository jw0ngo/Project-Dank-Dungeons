...
*Regenerated from `index.html`'s `// §` banners by `tools/gen-code-map.py` (2026-06-13, 17935 lines). Re-run the tool after adding/moving a section or a notable system; **edit the banners, not this file.** Sections appear in FILE ORDER (the § numbers are stable names, not positions — e.g. §10 INIT lives near the end).*
...
*lines 7760–8314* · 8 function(s) · 1 knob(s)
...
## §6f  RENDER
*lines 8315–10329* · 35 function(s) · 14 knob(s)
...
## §6g  GAME LOOP
*lines 10330–10783* · 9 function(s) · 2 knob(s)
...
## §7  MULTIPLAYER
*lines 10784–11804* · 21 function(s) · 6 knob(s)
...
*lines 11805–12229* · 30 function(s) · 3 knob(s)
...
## §9  MAP SEED SYSTEM
*lines 12230–13748* · 78 function(s) · 16 knob(s)
...
## §11  WILDERNESS MODE
*lines 13749–14457* · 5 function(s) · 10 knob(s)
...
*lines 14458–16013* · 64 function(s) · 28 knob(s)
...
## §12b  OBELISK SYSTEM
*lines 16014–16185* · 6 function(s) · 12 knob(s)
...
## §13  FOG OF WAR
*lines 16186–16535* · 9 function(s) · 10 knob(s)
...
## §15  SHRINE SYSTEM
*lines 16824–16921* · 3 function(s) · 1 knob(s)
...
## §10  INIT
*lines 16922–17473* · 33 function(s) · 2 knob(s)
...
*lines 17474–17935* · 6 function(s) · 0 knob(s)
