...
*Regenerated from `index.html`'s `// §` banners by `tools/gen-code-map.py` (2026-06-13, 17955 lines). Re-run the tool after adding/moving a section or a notable system; **edit the banners, not this file.** Sections appear in FILE ORDER (the § numbers are stable names, not positions — e.g. §10 INIT lives near the end).*
...
*lines 6482–7779* · 49 function(s) · 129 knob(s)
...
*lines 7780–8334* · 8 function(s) · 1 knob(s)
...
## §6f  RENDER
*lines 8335–10349* · 35 function(s) · 14 knob(s)
...
## §6g  GAME LOOP
*lines 10350–10803* · 9 function(s) · 2 knob(s)
...
## §7  MULTIPLAYER
*lines 10804–11824* · 21 function(s) · 6 knob(s)
...
*lines 11825–12249* · 30 function(s) · 3 knob(s)
...
## §9  MAP SEED SYSTEM
*lines 12250–13768* · 78 function(s) · 16 knob(s)
...
## §11  WILDERNESS MODE
*lines 13769–14477* · 5 function(s) · 10 knob(s)
...
*lines 14478–16033* · 64 function(s) · 28 knob(s)
...
## §12b  OBELISK SYSTEM
*lines 16034–16205* · 6 function(s) · 12 knob(s)
...
## §13  FOG OF WAR
*lines 16206–16555* · 9 function(s) · 10 knob(s)
...
## §15  SHRINE SYSTEM
*lines 16844–16941* · 3 function(s) · 1 knob(s)
...
## §10  INIT
*lines 16942–17493* · 33 function(s) · 2 knob(s)
...
*lines 17494–17955* · 6 function(s) · 0 knob(s)
